# Generated by Django 3.1.4 on 2020-12-16 12:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.IntegerField(choices=[(0, 'Doctor'), (1, 'Pharmacist'), (2, 'Patient')])),
                ('gender', models.IntegerField(choices=[(0, 'Female'), (1, 'Male'), (2, 'Lesbian'), (3, 'Gay'), (4, 'Bisexual'), (5, 'Transgender'), (6, 'Queer')])),
                ('specialization', models.CharField(blank=True, max_length=250, null=True)),
                ('license_number', models.CharField(blank=True, max_length=250, null=True)),
